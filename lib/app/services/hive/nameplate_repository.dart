...
//   /// Get all product URIs from nameplate data
//   Future<List<String>> getProductUris() async {
//     try {
//       // First check if Hive box is available
//       if (!HiveService.hasNameplateData()) {
//         throw Exception('No nameplate data available in cache');
//       }

//       final List<String> uris = [];

//       // Check for cached product URI specifically
//       final cachedUri = HiveService.getNameplateProperty<String>(
//         'uriOfTheProduct',
//       );
//       if (cachedUri != null && cachedUri.startsWith('http')) {
//         uris.add(cachedUri);
//       }

//       // Check all stored nameplate keys for URI-like properties
//       final keys = HiveService.getNameplateKeys();
//       for (final key in keys) {
//         if (key.toString().toLowerCase().contains('uri')) {
//           final value = HiveService.getNameplateProperty<String>(
//             key.toString(),
//           );
...
//       return uris.toSet().toList(); // Remove duplicates
//     } catch (e) {
//       throw Exception('Error retrieving product URIs: ${e.toString()}');
//     }
//   }
// }
